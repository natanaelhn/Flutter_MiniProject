...
class _MyListAnimeScreenState extends State<MyListAnimeScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      context.read<MyListAnimeProvider>().setMyListAnime();
    });
  }
  ...
  Widget build(BuildContext context) {
    return MyScaffold(
      ...
      onRefresh: () async {
        context.read<MyListAnimeProvider>().setAllListNull(doNotifyListeners: true);
        context.read<MyListAnimeProvider>().setMyListAnime();
      },
                          ...
                          children: [
                            ...
                            Tooltip(
                              ...
                              child: InkWell(
                                onTap: () async{
                                  ...
                                  if(myListAnimeChanged == true && mounted){
                                    context.read<MyListAnimeProvider>().setAllListNull(doNotifyListeners: true);
                                    context.read<MyListAnimeProvider>().setMyListAnime();
                                  }
                            ...
                            Tooltip(
                              ...
                              child: InkWell(
                                onTap: (){
                                  try{
                                    context.read<MyListAnimeProvider>().deleteMyListAnime(id: animeDetailObject.id);
